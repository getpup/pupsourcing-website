...
For multiple projections or partitioned execution, see the [scaling guide](./scaling.md) and [examples](https://github.com/getpup/pupsourcing/tree/main/examples).
...
- [Examples](https://github.com/getpup/pupsourcing/tree/main/examples) - Deployment examples
